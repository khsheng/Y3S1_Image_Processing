# ============================================================
# EXPERIMENT 1 — YOLOv8m + MEDIAN K=9 + CLAHE + MILD UNSHARP
# ============================================================
...
ENHANCED_ROOT = os.path.join(
    os.getcwd(),
    "pcb-defect-dataset-median_filtering_(K=9)_and_CLAHE+MildUnsharp"
)
...
# ============================================================
# 3. MILD UNSHARP MASK FUNCTION
# ============================================================

def mild_unsharp(image, sigma=1.0, amount=0.4):
...
print("Location:", ENHANCED_ROOT)
print("data.yaml:", ENHANCED_YAML)