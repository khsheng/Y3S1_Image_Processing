...
# ============================================================
# 9. APPLY COMBINED MEDIAN FILTER + CLAHE FUNCTION
# ============================================================

def apply_median_and_clahe(
    image,
    kernel_size=3,
    clip_limit=2.0,
    tile_grid_size=(8, 8)
    ...
    2. Apply CLAHE on the L-channel (LAB space) for local contrast enhancement.
    """
...
COMBINED_DATASET_ROOT = os.path.join(os.getcwd(), "pcb-defect-dataset-median-(K=9)-clahe")
...
def preprocess_split(split):
    ...
    for filename in image_files:
        ...
        # Apply Median Filter + CLAHE
        processed_image = apply_median_and_clahe(
            image,
            kernel_size=9,
            clip_limit=2.0,
            tile_grid_size=(8, 8)
...
print("\n==============================================")
print("STARTING MEDIAN + CLAHE PREPROCESSING")
print("==============================================")
...
print("\nMedian + CLAHE preprocessing completed.")
...
# ============================================================
# 14. DISPLAY ORIGINAL VS MEDIAN + CLAHE
# ============================================================
...
print("\n==============================================")
print("ORIGINAL VS MEDIAN + CLAHE")
print("==============================================")
