...
# MEDIAN K=9 + CLAHE + EDGE ENHANCEMENT
# ============================================================
...
ENHANCED_ROOT = os.path.join(
    os.getcwd(),
    "pcb-defect-dataset-median_filtering_(K=9)_and_CLAHE+EdgeEnhancement"
)

print("\n==============================================")
print("E2 ENHANCED DATASET")
print("==============================================")
...
# ============================================================
# 3. EDGE ENHANCEMENT FUNCTION
# ============================================================

def edge_enhancement(image, strength=0.25):
...
for split in ["train", "val", "test"]:
    ...
    if os.path.exists(original_images):
        ...
        image_files = [
            f for f in os.listdir(original_images)
            if f.lower().endswith(
                (
                    ".jpg",
                    ".jpeg",
        ...
        print(
            f"\n{split.upper()} images: {len(image_files)}"
        )
    ...
    if os.path.exists(original_labels):
        ...
        label_files = [
            f for f in os.listdir(original_labels)
